...
contract IntegrationTest is Test, Bytes {
    ...
    function setUp() public {
        ...
        constructorArgs = abi.encode(address(pearlV2Factory), address(weth), address(7));
        ...
        returns (uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
    {
        ...
        tERC20.approve(address(nonfungiblePositionManager), amount0ToAdd);
        tERC20X.approve(address(nonfungiblePositionManager), amount1ToAdd);
