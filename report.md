...
- Found in src/GaugeV2.sol [Line: 335](src/GaugeV2.sol#L335)

	```solidity
	        nonfungiblePositionManager.safeTransferFrom(
	```

- Found in src/GaugeV2.sol [Line: 628](src/GaugeV2.sol#L628)

	```solidity
	            rewardToken.safeTransferFrom(DISTRIBUTION, address(this), reward);
	```

- Found in src/GaugeV2.sol [Line: 807](src/GaugeV2.sol#L807)
...
- Found in src/GaugeV2.sol [Line: 258](src/GaugeV2.sol#L258)

	```solidity
	    function setALMGauge(address _gauge) external onlyOwner {
	```

- Found in src/GaugeV2.sol [Line: 264](src/GaugeV2.sol#L264)

	```solidity
	    function setDistribution(address _distribution) external onlyOwner {
	```

- Found in src/GaugeV2.sol [Line: 757](src/GaugeV2.sol#L757)
...
- Found in src/GaugeV2.sol [Line: 173](src/GaugeV2.sol#L173)

	```solidity
	    function initialize(
	```

- Found in src/GaugeV2.sol [Line: 1219](src/GaugeV2.sol#L1219)
...
- Found in src/GaugeV2ALM.sol [Line: 309](src/GaugeV2ALM.sol#L309)
...
- Found in src/Voter.sol [Line: 96](src/Voter.sol#L96)
...
- Found in src/GaugeV2.sol [Line: 554](src/GaugeV2.sol#L554)

	```solidity
	            : _globalTick != TickMath.MAX_TICK - 1;
	```

- Found in src/GaugeV2.sol [Line: 594](src/GaugeV2.sol#L594)

	```solidity
	                _globalTick = zeroForOne ? tickNext - 1 : tickNext;
	```

- Found in src/GaugeV2.sol [Line: 697](src/GaugeV2.sol#L697)

	```solidity
	        nonce += 1;
	```

- Found in src/GaugeV2.sol [Line: 872](src/GaugeV2.sol#L872)

	```solidity
	            stakedBalance[owner] += 1;
	```

- Found in src/GaugeV2.sol [Line: 912](src/GaugeV2.sol#L912)

	```solidity
	                stakedBalance[owner] -= 1;
	```

- Found in src/GaugeV2.sol [Line: 1181](src/GaugeV2.sol#L1181)
...
- Found in src/GaugeV2.sol [Line: 141](src/GaugeV2.sol#L141)
...
- Found in src/GaugeV2.sol [Line: 156](src/GaugeV2.sol#L156)

	```solidity
	    event Collect(
	```

- Found in src/GaugeV2.sol [Line: 163](src/GaugeV2.sol#L163)

	```solidity
	    event RewardBridged(address indexed gauge, uint256 reward);
	```

- Found in src/GaugeV2.sol [Line: 164](src/GaugeV2.sol#L164)

	```solidity
	    event RewardAdded(uint256 reward, uint256 residueAmount);
	```

- Found in src/GaugeV2.sol [Line: 165](src/GaugeV2.sol#L165)

	```solidity
	    event RewardCredited(uint64 nonceId, uint256 reward);
	```

- Found in src/GaugeV2.sol [Line: 166](src/GaugeV2.sol#L166)
...
- Found in src/GaugeV2.sol [Line: 259](src/GaugeV2.sol#L259)

	```solidity
	        require(_gauge != address(0));
	```

- Found in src/GaugeV2.sol [Line: 265](src/GaugeV2.sol#L265)

	```solidity
	        require(_distribution != address(0));
	```

- Found in src/GaugeV2.sol [Line: 322](src/GaugeV2.sol#L322)

	```solidity
	        require(to != address(0) && to != address(this));
	```

- Found in src/GaugeV2.sol [Line: 1040](src/GaugeV2.sol#L1040)
...
- Found in src/GaugeV2.sol [Line: 272](src/GaugeV2.sol#L272)
