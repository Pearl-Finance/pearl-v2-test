...
library VirtualTick {
    ...
    function getRewardsGrowthInside(
        ...
        unchecked {
            ...
            if (tickCurrent >= tickLower) {
                ...
                rewardsGrowthBelowX128 = rewardsGrowthGlobalX128 - lower.rewardsGrowthOutsideX128;
            }
            ...
            if (tickCurrent < tickUpper) {
                ...
                rewardsGrowthAboveX128 = rewardsGrowthGlobalX128 - upper.rewardsGrowthOutsideX128;
            }

            rewardsGrowthInsideX128 = rewardsGrowthGlobalX128 - rewardsGrowthBelowX128 - rewardsGrowthAboveX128;
        }
    }
    ...
    function clear(mapping(int24 => VirtualTick.Info) storage self, int24 tick) internal {
        delete self[tick];
    }
    ...
    function cross(mapping(int24 => VirtualTick.Info) storage self, int24 tick, uint256 rewardsGrowthGlobalX128)
        internal
        returns (int128 liquidityNet)
    {
        unchecked {
            VirtualTick.Info storage info = self[tick];
            info.rewardsGrowthOutsideX128 = rewardsGrowthGlobalX128 - info.rewardsGrowthOutsideX128;
