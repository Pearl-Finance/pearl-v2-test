...
interface IGaugeV2ALM {
     ...
     * @param _lzPoolChainId The layerZero chaind id of the pool.
     ...
     */
    function createGauge(address rewardToken, address almBox, address gaugeCL, address lBoxManager)
        external
        returns (address);
     ...
     */
    function claimManagementFees(address to) external returns (uint256 collectedfees);
     ...
     */
    function earnedFees() external view returns (uint256 amount0, uint256 amount1);
