...
interface IBribe {
     ...
     */
    function emergencyRecoverERC20AndRecoverData(bytes calldata data, bool isRecoverERC20AndUpdateData) external;
     ...
     */
    function convertBribeToken(address _token, uint256 _amount, address _target, bytes calldata _data) external;
