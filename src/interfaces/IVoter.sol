...
interface IVoter {
     ...
     */
    function poolVote(address account, uint256 _index) external view returns (address _pair);
     ...
     */
    function votes(address account, address _pool) external view returns (uint256 votes);
