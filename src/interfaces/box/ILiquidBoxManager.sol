...
interface ILiquidBoxManager {
     ...
     */
    function getBox(address token0, address token1, uint24 fee) external view returns (address box);
     ...
     */
    function claimFees(address box, address to) external returns (uint256 claimed0, uint256 claimed1);
     ...
     * @dev This function is view-only and does not modify the state of the contract.
     */
    function getLimits(address box) external view returns (int24 baseLower, int24 baseUpper);
     ...
     * @dev This function is view-only and does not modify the state of the contract.
     */
    function getClaimableFees(address box, address to) external view returns (uint256 claimable0, uint256 claimable1);
